...
public class NewTournamentFilter implements Filter {

	private final static String ATT_USER = "user";
	private final static String ADMIN_ROLE = "admin";
	private final static String ORGANIZER_ROLE = "organizer";
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        boolean organizerUser = ((User) session.getAttribute(ATT_USER)).getRole().equals(ORGANIZER_ROLE);
        
        if (session.getAttribute(ATT_USER) == null || (!adminUser && !superAdminUser && !organizerUser)) {
